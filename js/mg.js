 ...
 * 	@param pauseAuto:boolean - if it pauses automatic
 */
Mg.prototype.prev = function(evnt, alsoLinked, pauseAuto, isAuto, passedArgument){
	var thisEvnt = this[evnt];
	...
	//
	if(thisEvnt.prevClick != undefined && !isAuto){thisEvnt.prevClick(passedArgument);}
 ...
 * 	@param pauseAuto:boolean - if it pauses automatic
 */
Mg.prototype.next = function(evnt, alsoLinked, pauseAuto, isAuto, passedArgument){
	var thisEvnt = this[evnt];
	var length = this.totalItems;
	var start = 0;
	if(!(thisEvnt.multiMode=='centered' && thisEvnt.cycle==true)){ // if centered and cycle you can't have toSteps
	...
	//
	if(thisEvnt.nextClick != undefined && !isAuto){thisEvnt.nextClick(passedArgument);}
